...
describe('Ticket e2e test', () => {
  ...
  // const ticketSample = {"ticketCode":"4{6, 10}","issuedAt":"2023-06-10T07:39:51.937Z","entryTime":"2023-06-10T17:53:11.559Z","exitTime":"2023-06-10T22:55:35.017Z","status":"EXPIRED"};
  ...
  describe('new Ticket page', () => {
    ...
    it.skip('should create an instance of Ticket', () => {
      ...
      cy.get(`[data-cy="issuedAt"]`).type('2023-06-11T00:35').blur().should('have.value', '2023-06-11T00:35');

      cy.get(`[data-cy="entryTime"]`).type('2023-06-10T10:21').blur().should('have.value', '2023-06-10T10:21');

      cy.get(`[data-cy="exitTime"]`).type('2023-06-10T17:30').blur().should('have.value', '2023-06-10T17:30');
