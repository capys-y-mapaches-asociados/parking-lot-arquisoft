...
describe('Customer e2e test', () => {
  ...
  const customerSample = {
    firstName: 'Danny',
    lastName: 'Legros',
    email: 'r48.s@iZ.Yel4N2.95xz.YH_RE.2.Gtu6',
    password: 'b526b8de2FB4BEd7DEcFCb74f25097e7FDA8Daf4662BD5657c0aDEc8013FE47c',
  };
  ...
  describe('new Customer page', () => {
    ...
    it('should create an instance of Customer', () => {
      ...
      cy.get(`[data-cy="email"]`).type('no@0x.ijl6V._Mf').should('have.value', 'no@0x.ijl6V._Mf');

      cy.get(`[data-cy="password"]`)
        .type('2c2525fdAeeCD2BbD6bAdCae5aEEBAd6c125B931b7e885f1399b2eeDBBeF2Bda')
        .should('have.value', '2c2525fdAeeCD2BbD6bAdCae5aEEBAd6c125B931b7e885f1399b2eeDBBeF2Bda');
