...
public class ParkingLotResource {
    ...
    private static final String ENTITY_NAME = "parkingLot";
    ...
    /**
     * {@code SEARCH  /_search/parking-lots?query=:query} : search for the parkingLot corresponding
     * to the query.
     *
     * @param query the query of the parkingLot search.
     * @return the result of the search.
     */
    @GetMapping("/_search/parking-lots")
    public Mono<List<ParkingLotDTO>> searchParkingLots(@RequestParam String query) {
        log.debug("REST request to search ParkingLots for query {}", query);
        return parkingLotService.search(query).collectList();
    }
}
