...
public class BarrierResource {
    ...
    private static final String ENTITY_NAME = "barrier";
    ...
    /**
     * {@code SEARCH  /_search/barriers?query=:query} : search for the barrier corresponding
     * to the query.
     *
     * @param query the query of the barrier search.
     * @return the result of the search.
     */
    @GetMapping("/_search/barriers")
    public Mono<List<BarrierDTO>> searchBarriers(@RequestParam String query) {
        log.debug("REST request to search Barriers for query {}", query);
        return barrierService.search(query).collectList();
    }
}
