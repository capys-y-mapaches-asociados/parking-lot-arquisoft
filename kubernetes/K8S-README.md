...
```
$ docker image tag gateway zacwastaken/gateway
$ docker push zacwastaken/gateway
$ docker image tag parking zacwastaken/parking
$ docker push zacwastaken/parking
$ docker image tag reservations zacwastaken/reservations
$ docker push zacwastaken/reservations
$ docker image tag payments zacwastaken/payments
$ docker push zacwastaken/payments
```
